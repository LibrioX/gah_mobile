    ...
    ElevatedCard(
        ...
        Column(
            ...
            Column(
                ...
                rooms.map {
                    Row(
                        ...
                        Text(
                            text = "${it.quantity} x Kamar ${it.jenisKamar}",
                            style = MaterialTheme.typography.labelMedium,
                        )
                        Text(
                            text = numberFormatRupiah(it.totalPrice),
            ...
            Row(
                ...
                Text(
                    text = "${numberFormatRupiah((totalNights * rooms.sumOf { it.totalPrice }).toInt())}",
                    style = MaterialTheme.typography.titleLarge,
                    color = successText
                )
            ...
            if(layanan.isNotEmpty()){
                ...
                Column(
                    ...
                    layanan.map {
                        Row(
                            ...
                            Text(
                                text = "${it.quantity} x ${it.nama_layanan}",
                                style = MaterialTheme.typography.labelMedium,
                            )
                            Text(
                                text = numberFormatRupiah(it.totalPrice),
                ...
                Row(
                    ...
                    Text(
                        text = "${numberFormatRupiah(layanan.sumOf { it.totalPrice })}",
                        style = MaterialTheme.typography.titleLarge,
                        color = successText
                    )
